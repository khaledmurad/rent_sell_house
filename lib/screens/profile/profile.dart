...
//                      _Widgets("Reservation applications", FontAwesomeIcons.book, Reservation_App(user: widget.user,)),
                      Text(AppLocalizations.of(context).sUPPORT,style: TextStyle(fontFamily: 'poppinslight',
                          ...
                          fontWeight: FontWeight.bold)),
                      SizedBox(height: size.height*0.025,),
                      //_Widgets(AppLocalizations.of(context).notifications, FontAwesomeIcons.bell, NotificationsPage()),
                      _Widgets(AppLocalizations.of(context).give_feedback, FontAwesomeIcons.solidCommentDots, FeedbackPage(user: widget.user,)),
                      _Widgets(AppLocalizations.of(context).contact_Us, FontAwesomeIcons.phoneAlt, ContactUSPage(user: widget.user,)),
                      _Widgets(AppLocalizations.of(context).settings, FontAwesomeIcons.cog, SettingsPage(user: widget.user,)),
                      Column(
                        children: [
                          GestureDetector(
                            onTap: (){
                              FirebaseFirestore.instance.collection("Users").doc(widget.user.uid)
                                  .collection("tokens").doc("token").update({
                                "token" : ""
                              });
                              main();
                            ...
                            child: Container(
                              ...
                              child: Center(
                                child: Text(AppLocalizations.of(context).lOGOUT,style: TextStyle(fontFamily: 'poppinsbold',
                                    color: Colors.white,
                                    fontSize: 15,
                                    fontWeight: FontWeight.bold)),
                              ),
